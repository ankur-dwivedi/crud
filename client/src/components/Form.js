...
export default function Form() {
  ...
  const [image, setImage] = useState(path.length===11?"http://localhost:3000/uploads/" +(path[10]):"")
  const show = event => {
          ...
          <div className={classes.form}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                />
                 {errors.address?.type === "required" && <spam className={classes.error}>Enter your address</spam>}
              </Grid>
              <Grid item xs={12}>
                <TextField
                  id="date"
              ...
              <Grid item xs={12} >
                ...
                <RadioGroup aria-label="gender" className={classes.Radio} defaultValue={path.length===11 ? path[8]:""}>
              ...
              <Grid item xs={12} >
                ...
                <Controller
                  name="country"
                  control={control}
                  defaultValue={path.length===11?path[9]:"India"}
            ...
            <Grid container justify="flex-end">
              <Grid item>
                <NavLink to="/" variant="body2">
                  Skip and view all added employees
              </NavLink>
              </Grid>
            </Grid>
          </div>
